...
# %%
def visualize_position_heatmap(pyarrow_table: pa.Table) -> None:
    # Extract x and y values
    x = pyarrow_table["p1_position_x"].to_numpy()
    y = pyarrow_table["p1_position_y"].to_numpy()
    ...
    ax.set_title("Player 1 Position Heatmap")
...
visualize_position_heatmap(table)
