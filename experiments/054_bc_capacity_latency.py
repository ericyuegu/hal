...
LATENCY_MANIFEST_PATH: Final[Path] = Path("runs/054_iso_data_latency_manifest.json")
...
class TrainArgs:
    ...
    latency_manifest: Path = LATENCY_MANIFEST_PATH
    proxy: bool = False
    comment: str = ""
...
class LatencyPreflightArgs:
    output: Path = LATENCY_MANIFEST_PATH
