"""011e: 011d (AR-over-groups head) + relfeat (opp-relative spatial features).

The two winrate-positive ideas stacked: 011c's nonlinear ego↔opp relative
channels (relfeat helped: 9.1%→12.3%, dmg 85→105) feed an autoregressive
groups head (within each frame group g conditions on realized groups 0..g-1),
which targets 009's conditional independence that 007 argued shreds closed-loop
execution coherence (the "deals damage but few kills" failure). d256, AdamW, compile.
