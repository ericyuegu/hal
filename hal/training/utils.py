...
def get_git_repo_root() -> Path:
    cmd = subprocess.check_output(["git", "rev-parse", "--show-toplevel"])
...
def repeater[T](it: Iterable[T]) -> Iterator[T]:
...
def move_tensors_to_device[T](inputs: T, device: str, non_blocking=True) -> T:
